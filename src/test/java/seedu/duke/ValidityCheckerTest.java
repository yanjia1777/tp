...
public class ValidityCheckerTest {
    ...
    public void checkEmptyName_emptyString_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkEmptyName(""));
    ...
    public void checkInvalidAmount_empty_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkInvalidAmount(""));
    ...
    public void checkInvalidAmount_alphabetMixed_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkInvalidAmount("24d"));
        assertEquals(thrown.getMessage(), MintException.ERROR_INVALID_AMOUNT);
    }
    ...
    public void checkInvalidAmount_negative_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkInvalidAmount("-2.8"));
        assertEquals(thrown.getMessage(), MintException.ERROR_INVALID_AMOUNT);
    }
    ...
    public void checkInvalidDate_letters_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkInvalidDate("abc"));
        assertEquals(thrown.getMessage(), MintException.ERROR_INVALID_DATE);
    }

    @Test
    public void checkInvalidDate_missingFields_throwException() {
        Exception thrown = assertThrows(MintException.class, () -> ValidityChecker.checkInvalidDate("2020-01"));
        assertEquals(thrown.getMessage(), MintException.ERROR_INVALID_DATE);
    }
